...
public class Activity_activtiy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idBTNStartR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(checkPermissionFromDevice() == true){
                    ...
                    Toast.makeText(Activity_activtiy.this, "Recording Started", Toast.LENGTH_SHORT).show();
                    try {
                    ...
                    ActivityCompat.requestPermissions(Activity_activtiy.this, new String[]{
        ...
        idBTNStartPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.start();
                Toast.makeText(Activity_activtiy.this, "Playing Audio", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        idBTNStopPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.stop();
                mediaPlayer.release();
                Toast.makeText(Activity_activtiy.this, "Stop Playing", Toast.LENGTH_SHORT).show();
            }
        });
